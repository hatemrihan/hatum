  ...
  const ThemeToggleButton = () => {
    ...
    return (
      <button
        ...
        className="p-3 rounded-md bg-black/5 dark:bg-white/5 hover:bg-black/10 dark:hover:bg-white/10 transition-colors duration-300 flex items-center justify-center"
